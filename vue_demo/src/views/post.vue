<template>
  <div class="container">
    <el-table :data="filterTableData" style="width: 100%" height="94%">
...
<!--          <p v-for="item in scope.row.comments">{{ item.username }}: {{ item.content }}</p>-->
      ...
      <el-table-column label="内容" prop="content" width="180px" align="center"/>
      ...
      <el-table-column label="歌曲ID" prop="songid" width="120px" align="center"/>
...
export default {
  ...
  data() {
    return {
      ...
      // 表格数据
      tableData: [
        {"post_id":1,"userid":"123","username":"测试人员","head":"http://106.52.19.146:8787/staticdata/DynamicImage/20230505/9cf0f9ca-9c2e-4e6d-bd37-51a5a74a38ce.jpg","post_time":"2023-04-13 14:01:57","content":"抢到第一，运气来自实力，实力来自努力。建议你们去好好调研一下。","picture":"http://106.52.19.146:8787/staticdata/DynamicImage/20230505/3cf8ea97-8111-4273-9124-c05b8238998d.png","songid":27804646,"comment_num":2,"like_num":1},
        {
          "post_id": 2,
          "userid": "1401930962",
          "username": "JL222",
          ...
          "picture": "http://106.52.19.146:8787/staticdata/DynamicImage/20230505/6c3a1952-1db0-4232-a96b-459252377c0e.jpg",
          "songid": null,
          "comment_num": 0,
          "like_num": 4
        }
