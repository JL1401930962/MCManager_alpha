<template>
  <div class="container">
    <el-table :data="filterTableData" style="width: 100%;" align="left" height="94%">
      <el-table-column type="index" label="index" align="left" width="80px"/>
      <el-table-column label="用户ID" prop="userid" width="150px" align="center"/>
      <el-table-column label="帖子ID" prop="post_id" width="150px" align="center"/>
      <el-table-column label="点赞状态" prop="like_state" width="150px" align="center"/>
  ...
  computed: {
    ...
    filterTableData() {
      return this.tableData.filter(
        (data) =>
          !this.search ||
          data.categoryName.includes(this.search)
      );
    },
  },
  methods: {
